import {
  ...
  ThreadMaterializationSetPayload as ContractsThreadMaterializationSetPayloadSchema,
...
export const ThreadMaterializationSetPayload = ContractsThreadMaterializationSetPayloadSchema;
